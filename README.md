...
| <img src="images/tap.png" width="260"> | **Taps.** A normal note of its row with a translucent purple tint over it, following GHL's "don't strum this" convention. (Shown inside a star power phrase, hence the gold outlines.) |
...
*The both-buttons screenshot predates v1.4's size change; every other image is current.*
